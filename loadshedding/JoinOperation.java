	...
	*/
	...
	public JoinOperation (String[] args) throws Exception{
		...
		if( type.equals("ORACLE") ) {
			...
			double sizeFIFO = Double.parseDouble(inputArguments.getOptionValue("sizeOfFIFO"));
			int thresHold= Integer.parseInt(inputArguments.getOptionValue("TH"));
			innerCache = new DataCacheARC (innerDir, innerSize, true, enableReasoning, outputDir, sizeFIFO);
			outerCache = outterDir==null?null:new DataCacheARC(outterDir, outterSize, false, enableReasoning, outputDir, sizeFIFO);
		}

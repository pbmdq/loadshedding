...
public class OracleMaking {
	...
	public String countingFuture (ResultSet rs, DataEntry inputEntry) {
		...
		try {
			 ...
			 buf.append(inputEntry.simTimeStamp+"\t"+sdf.format(inputEntry.timeStamp).toString()+"\t"+sdf.format(inputEntry.timeStampEnd).toString()+"\t"+inputEntry.key+"\t"+inputEntry.otherDataFields);
	...
	public void making () {
		...
		try {
			...
			while (fileScanner.hasNext() ) {
	            ...
	            String startTime =  sdf.format(newEntry.timeStamp).toString();
